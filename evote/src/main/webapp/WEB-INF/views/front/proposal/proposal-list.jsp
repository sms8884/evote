...
//<![CDATA[
	...
	function fnSearch(idx){
		...
		$("#sortItem").val(idx);
	    $("#searchFrm").prop("action", "/proposal/list").submit();
	}
	...
	function fnMovePsType(psSearchType){
	    ...
	    $("#_tempFrm").prop("action", "<c:url value="/proposal/list" />").submit();
	}
	
	function fnMoveDetail(propSeq) {
		$('#_tempFrm').prop('method', 'post');
	    $('#_tempFrm').prop('action', '/proposal/detail/' + propSeq).submit();
	}
		...
		<div class="contentsWrap">
			...
			<div class="contents">
							...
							<table cellpadding="0" cellspacing="0" class="" summary="" >
								...
								<tbody>
									<tr>
										...
										<th scope="row">구분</th>
										<td>
					                        <select name="status" id="status" title="구분 선택하기" style="width:231px;">
				...
				<jsp:include page="/WEB-INF/views/front/common/paging.jsp">
					...
					<jsp:param name="action" value="/proposal/list"/>
				</jsp:include>
