					...
					<table cellpadding="0" cellspacing="0" class="tbL" summary="" >
						...
						<tbody>
							<tr>
								...
								<td>
									<c:choose>
										...
										<c:otherwise><input type="text" name="append1" id="append1" placeholder=" 이름을 입력해주세요" style="width:350px; height:30px; border:1px solid #d3d0c9;"/></c:otherwise>
									</c:choose>
									<p>
							...
							<tr>
								...
								<td>
									<c:choose>
										...
										<c:otherwise><input type="text" name="append3" id="append3" placeholder=" 이메일을 입력해주세요" style="width:350px; height:30px; border:1px solid #d3d0c9;"/></c:otherwise>
									</c:choose>
									<p>
							...
							<tr>
								<th>제목</th>
								<td>
									<input type="text" name="title" id="title" style="width:580px; height:30px; border:1px solid #d3d0c9;"/>
								</td>
							</tr>
							<tr>
								...
								<td colspan="3">
									<div class="writeW">
										<textarea name="cont" id="cont" cols="10" rows="10" title="제안취지 입력" style="width:570px;"></textarea>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input type="password" name="password" id="password" style="width:350px; height:30px; border:1px solid #d3d0c9;" maxlength="16"/>
									<p>
										<span class="red2">※ 6-16자의 비밀번호를 입력하세요</span>
									</p>
								</td>
							</tr>
							</c:if>
