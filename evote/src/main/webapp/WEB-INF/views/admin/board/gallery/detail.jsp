			...
			<div class="contentWrap">
				...
				<div class="content">
					...
					<div class="mainContent" style="width:100%;">
						...
						<div class="btnbox_GL1">
							<a href="#" onclick="remove('${boardPost.postSeq}'); return false;" class="btn_gray" style="float:left;">삭제</a>
					...
					<div class="boardGlist">
						<p class="boardGlist_btn">
							...
							<c:if test="${not empty nextPost}">
								<a href="javascript:detail('${nextPost.postSeq}');" class="btn_right" >다음글 <img src="${siteImgPath}/common/btn_next3.gif" alt="다음글보기"/></a>
							</c:if>
						</p>
						<c:if test="${not empty prevPost}">
							<dl>
