...
$(document).ready(function(){
	...
	$("#btn_reg").on("click", function(e) {
		...
		$('#form').attr('action', "/admin/vote/voteItemReg").submit();		
	});
							...
							<table cellpadding="0" cellspacing="0" class="tbL">
								...
								<tbody>
											...
											<select id="realm_cd" name="realm_cd" style="width:140px;">												
												<c:if test="${!empty voteRealmList}">
													<c:forEach var="realm" items="${voteRealmList}" varStatus="status" >
														<option value="${realm.realm_cd}">${realm.realm_nm}</option>
													</c:forEach>
												</c:if>		
											</select>										
										</td>
									...
									<tr>
										<th scope="row">사업명</th>
										<td colspan="3">
											<input type="text" class="it wid498" id="biz_nm" name="biz_nm" maxlength="40">
									...
									<tr>
										...
										<td colspan="3">
											<input type="text" class="it wid125" id="budget" name="budget" maxlength="20"><span class="red">20자 입력제한</span>										
										</td>
									</tr>
									<tr>
										<th scope="row">사업기간</th>
										<td colspan="3">
											<label for="start_date" class="hidden">시작기간 입력하기</label><input type="text" class="it wid125" id="start_date" name="start_date" readOnly/><img src="${siteImgPath}/common/icon_cal.gif" id="img_sd"/> ~											
											<label for="end_date" class="hidden">종료기간 입력하기</label><input type="text" class="it wid125" id="end_date" name="end_date" readOnly/><img src="${siteImgPath}/common/icon_cal.gif" id="img_ed"/>		
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											...
											<input type="text" class="it wid125" id="location" name="location" maxlength="100">		
										</td>
									</tr>
									<tr>
										...
										<td style="border-right-style: none;" colspan="3">
											<div class="writeW">
												<textarea cols="10" rows="10" title="제안취지 입력" class="wid100" id="necessity" name="necessity" maxlength="2000" onkeyup="return checkmaxlength(this,'최대 2000자까지 입력가능합니다.');" ></textarea>
											</div>
									...
									<tr>
										...
										<td style="border-right-style: none;" colspan="3">
											<div class="writeW">
												<textarea cols="10" rows="10" title="내용입력" class="wid100" id="biz_cont" name="biz_cont" maxlength="2000" onkeyup="return checkmaxlength(this,'최대 2000자까지 입력가능합니다.');"></textarea>
											</div>
											<span class="red2">최대 2000자까지 입력가능</span>
										</td>
									</tr>
									<tr>
										...
										<td style="border-right-style: none;" colspan="3">
											<div class="writeW">
												<textarea cols="10" rows="10" title="기대효과 입력" class="wid100" id="effect" name="effect" maxlength="2000" onkeyup="return checkmaxlength(this,'최대 2000자까지 입력가능합니다.');" ></textarea>
											</div>
											<span class="red2">최대 2000자까지 입력가능</span>
										</td>
									</tr>
