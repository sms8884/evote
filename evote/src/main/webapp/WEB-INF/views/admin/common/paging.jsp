	...
	<span class="num">
		<c:choose>
			<c:when test="${pagingHelper.prevPaging eq -1}">
				<a ><img src="${siteImgPath}/common/btn_prev1.gif" alt="처음"/></a>
				<a ><img src="${siteImgPath}/common/btn_prev2.gif" alt="이전페이지로 이동"/></a>
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			<c:when test="${pagingHelper.nextPaging eq -1}">
				<a ><img src="${siteImgPath}/common/btn_next1.gif" alt="다음페이지로 이동"/></a>
				<a ><img src="${siteImgPath}/common/btn_next2.gif" alt="끝"/></a>
			</c:when>
			<c:otherwise>
