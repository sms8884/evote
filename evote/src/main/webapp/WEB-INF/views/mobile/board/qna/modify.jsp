	...
	<div class="boardWrite">
		...
		<table cellpadding="0" cellspacing="0" class="tbL" summary="" >
			...
			<tbody>
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise><p class="inputBox"><input type="text" class="it " name="append1" id="append1" value="${boardPost.append1}" placeholder=" 이름을 입력해주세요"/></p></c:otherwise>
						</c:choose>
				...
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:otherwise><p class="inputBox"><input type="text" class="it " name="append3" id="append3" value="${boardPost.append3}" placeholder=" 이메일을 입력해주세요"/></p></c:otherwise>
						</c:choose>
					...
					<td>
						...
						<c:if test="${board.secUseYn eq 'Y'}">
							...
							<c:if test="${boardPost.secYn eq 'Y'}">
								<script>$("#tmpSecYn").attr("checked", "checked");</script>
							</c:if>
						</c:if>
					</td>
				</tr>
				<tr>
					<th scope="row">제목</th>
					<td><p class="inputBox"><input type="text" class="it " name="title" id="title" value="${boardPost.title}"/></p></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="bln">
						<p class="textareaBox"><textarea name="cont" id="cont" style="text-indent:0px;"><c:out value="${boardPost.cont}"/></textarea></p>
		...
		<p class="writeBt">
			<a href="#" class="blue" onclick="modifyProc(); return false;">수정하기</a>
