...
<div class="wrap">
	...
	<div id="div-join-step1">
		...
		<div class="memeberNext">
			...
			<a href="/member/join-email" class="phoneMember">이메일로 가입</a>
		</div>
...
<!-- 	
			<div class="memb">
				<p class="tit">이름</p>
				<p class="login1">
					<input type="text" class="it " title="" value="" name="" placeholder="필수입력"/>
				</p>
			</div>
			<div class="memb">
				<p class="tit">닉네임</p>
				<p class="login2">
					<span><input type="text" class="it " title="" value="" name="" placeholder="은평이"/></span>
					<a href="#" class="bt2">중복확인</a>
				</p>
			</div>
 -->			
			<div class="memb">
